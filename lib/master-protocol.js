...
/** The general teachings that ship with Baton (lib/TEACHINGS.general.md) — never the user's own file. */
...
function conductorProtocolText(opts = {}) {
  const C = CONDUCTOR_PROTOCOL, L = ['Baton CONDUCTOR OPERATING PROTOCOL', '', C.role, '', 'AUTONOMY: ' + AUTONOMY];
  let n = 0;

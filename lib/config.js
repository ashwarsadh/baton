...
const DEFAULTS = {
  ...
  // message. spareRemoteControl: Remote Control lives in the CLI, so an RC session is left alone unless false.
  reaper: { idleHours: 3, dryHours: 24, maxPerTick: 6, spareRemoteControl: true },
